...
function primerapagina_setup() {
	...
	add_image_size( 'image-clases',400, 350, true);
...
function primerapagina_scripts() {
	...
	wp_enqueue_script( 'primarapagina-isotopes',get_template_directory_uri(  ) . '/js/isotope.pkgd.min.js', array('jquery'), _S_VERSION );
	wp_enqueue_script( 'primerapagina-iniciar-js',get_template_directory_uri(  ) . '/js/iniciar_js_primerapagina.js', array('jquery'), _S_VERSION );
